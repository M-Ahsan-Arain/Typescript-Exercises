/* Album: Write a function called make_album() that builds a Object describing a music album. The function should take in an artist name and 
an album title, and it should return a Object containing these two pieces of information. Use the function to make
...
function make_album(artist:string, title:string, numTracks?:number){
...
const album2 = make_album("artist2", "title2", 2);
